...
subroutine FlowConditionRead(condition,input,option)
  ...
  pressure => FlowSubConditionCreate(option%nfluid)
  pressure%name = 'pressure'
  saturation => FlowSubConditionCreate(option%nfluid)
  saturation%name = 'saturation'
  rate => FlowSubConditionCreate(option%nfluid)
  rate%name = 'rate'
  flux => FlowSubConditionCreate(option%nfluid)
  flux%name = 'flux'
  conductance => FlowSubConditionCreate(option%nfluid)

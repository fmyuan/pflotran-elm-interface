...
subroutine WriteObservationDataForBC(fid,realization_base,patch,connection_set)
  ...
  PetscInt :: iphase
  PetscMPIInt :: int_mpi
  PetscReal :: sum_volumetric_flux(realization_base%option%flow%nfluid)
  PetscReal :: sum_volumetric_flux_global(realization_base%option%flow%nfluid)
  type(option_type), pointer :: option
  PetscErrorCode :: ierr

  ...
  ! --------------------
    ...
    select case (option%th_ice_model)
      ...
      case (PAINTER_KARRA_EXPLICIT, PAINTER_KARRA_EXPLICIT_SMOOTH)
        ...
        if(option%th_frzthw_halfwidth /= UNINITIALIZED_DOUBLE) &
          deltaTf = option%th_frzthw_halfwidth
        ...
        !--------------------------------------------
         if (option%th_ice_model==PAINTER_KARRA_EXPLICIT_SMOOTH .and. &
             deltaTf>1.0d-50) then

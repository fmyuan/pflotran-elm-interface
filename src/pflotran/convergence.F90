...
subroutine ConvergenceTest(snes_,it,xnorm,unorm,fnorm,reason,context,ierr)
  ! 
...
!        reason = 0
    ...
    if (option%print_screen_flag .and. solver%print_convergence) then
      ...
      if (option%use_mc .and. option%ntrandof > 0 .and. solver%itype == &
        ...
        write(*,'(i3," 2r:",es9.2, &
                ...
                & " iu:",es9.2, &
                & " irsec:",es9.2, &
                & " rsn: ",a, ", ",a)') it, fnorm, xnorm, unorm, inorm_residual, &
        ...
        write(*,'(i3," 2r:",es9.2, &
                ...
                & " ir:",es9.2, &
                & " iu:",es9.2, &
                & " rsn: ",a)') it, fnorm, xnorm, unorm, inorm_residual, &
    ...
    if (option%print_screen_flag .and. solver%print_convergence) then
      ...
      write(*,'(i3," 2r:",es10.2, &
              & " 2u:",es10.2, &
              & 32x, &
              & " rsn: ",a)') it, fnorm, unorm, trim(string)

...
!------------------------------------------------------------------------------------
  word = 'NH4+'
  this%ispec_nh4 = ReactionAuxGetPriSpecIDFromName(word,reaction,PETSC_FALSE,option)

  word = 'NO3-'
  this%ispec_no3 = ReactionAuxGetPriSpecIDFromName(word,reaction,PETSC_FALSE,option)
  ...
  word = 'PlantN'
  this%ispec_plantn = ReactionImGetSpeciesIDFromName(word, reaction%immobile, &
                 PETSC_FALSE, option)
  ...
  word = 'Plantndemand'
  this%ispec_plantndemand = ReactionImGetSpeciesIDFromName(word, reaction%immobile, &
                 PETSC_FALSE, option)

  word = 'Plantnh4uptake'
  this%ispec_plantnh4uptake = ReactionImGetSpeciesIDFromName(word, reaction%immobile, &
                 PETSC_FALSE, option)
  word = 'Plantno3uptake'
  this%ispec_plantno3uptake = ReactionImGetSpeciesIDFromName(word, reaction%immobile, &
                 PETSC_FALSE, option)

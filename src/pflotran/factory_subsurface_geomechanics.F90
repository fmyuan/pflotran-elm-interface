...
#include "petsc/finclude/petscsnes.h"
  ...
  public :: &
            FactorySubsurfGeomechInitSimulation!, & ! used in factory_subsurf
            !FactorySubsurfGeomechReadSimBlock, & ! used in factory_forward (identical to FactoryGeomechReadSimBlock)
            !SubsurfGeomechicsInitReadRequiredCards, & ! used in subsurf linkage
            !SubsurfGeomechanicsInitReadInput ! used in subsurf linkage
contains

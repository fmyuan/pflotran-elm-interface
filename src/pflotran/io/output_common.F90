...
#include "petsc/finclude/petscvec.h"
  ...
  call UGridCreateUGDM(grid%unstructured_grid,ugdm, &
                       (option_flow%nspecflow*MAX_FACE_PER_CELL + 1),option)
  ...
  allocate(vx(option_flow%nspecflow,MAX_FACE_PER_CELL,ugrid%nlmax))
  allocate(vy(option_flow%nspecflow,MAX_FACE_PER_CELL,ugrid%nlmax))
  allocate(vz(option_flow%nspecflow,MAX_FACE_PER_CELL,ugrid%nlmax))
  ...
  offset = 1 + option_flow%nspecflow*MAX_FACE_PER_CELL
  ...
  do 
    ...
    do iconn = 1, cur_connection_set%num_connections
      ...
      do dof=1,option_flow%nspecflow

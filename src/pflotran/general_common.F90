...
! Cutoff parameters
  ...
  public :: GeneralAccumulation, &
            ...
            GeneralFluxDerivativeLegacy, &
            GeneralBCFluxDerivativeLegacy, &
...
subroutine GeneralFluxLegacy(gen_auxvar_up,global_auxvar_up, &
                       material_auxvar_up, &
...
end subroutine GeneralFluxLegacy

subroutine GeneralBCFluxLegacy(ibndtype,auxvar_mapping,auxvars, &
                         gen_auxvar_up,global_auxvar_up, &
                         gen_auxvar_dn,global_auxvar_dn, &
                         material_auxvar_dn, &
                         thermal_conductivity_dn, &
...
end subroutine GeneralBCFluxLegacy

subroutine GeneralFluxDerivativeLegacy(gen_auxvar_up,global_auxvar_up, &
                                 material_auxvar_up, &
                                 thermal_conductivity_up, &
                                 gen_auxvar_dn,global_auxvar_dn, &
                                 material_auxvar_dn, &
...
!geh:print *, 'GeneralFluxDerivative'
  option%iflag = -2
  call GeneralFluxLegacy(gen_auxvar_up(ZERO_INTEGER),global_auxvar_up, &
                   material_auxvar_up, &
                   thermal_conductivity_up, &
                   gen_auxvar_dn(ZERO_INTEGER),global_auxvar_dn, &
                   material_auxvar_dn, &
  ...
  if (general_analytical_derivatives) then
    ...
    ! upgradient derivatives
    do idof = 1, option%nflowdof
      call GeneralFluxLegacy(gen_auxvar_up(idof),global_auxvar_up, &
                       material_auxvar_up, &
                       thermal_conductivity_up, &
                       gen_auxvar_dn(ZERO_INTEGER),global_auxvar_dn, &
                       material_auxvar_dn, &
...
end subroutine GeneralFluxDerivativeLegacy

subroutine GeneralBCFluxDerivativeLegacy(ibndtype,auxvar_mapping,auxvars, &
                                   gen_auxvar_up, &
                                   global_auxvar_up, &
                                   gen_auxvar_dn,global_auxvar_dn, &
                                   material_auxvar_dn, &
  ...
  Jdn = 0.d0
!geh:print *, 'GeneralBCFluxDerivativeLegacy'

  option%iflag = -2
  call GeneralBCFluxLegacy(ibndtype,auxvar_mapping,auxvars, &
                     gen_auxvar_up,global_auxvar_up, &
                     gen_auxvar_dn(ZERO_INTEGER),global_auxvar_dn, &
                     material_auxvar_dn, &
                     thermal_conductivity_dn, &
...
end subroutine GeneralBCFluxDerivativeLegacy

...
subroutine PNNL_NReact(this,Residual,Jacobian,compute_derivative, &
  ...
  if (compute_derivative) then
    ! NO3- -> NO2-
    cpk = Coc+K_S_OC_NO3
    drate_no3_no2_oc = rate_no3_no2 / (Coc/cpk) * (cpk - 1.d0) / (cpk*cpk) * &
                       rt_auxvar%pri_act_coef(this%oc_id)
    cpk = Cno3+K_S_NO3
    drate_no3_no2_no3 = rate_no3_no2 / (Cno3/cpk) * (cpk - 1.d0) / (cpk*cpk) * &
                        rt_auxvar%pri_act_coef(this%no3_id)
    drate_no3_no2_biomass = rate_no3_no2 / X
    cpk = Co2+K_I_O2
    drate_no3_no2_o2 = rate_no3_no2 / (K_I_O2/cpk) * -1.d0 * K_I_O2 / &
                       (cpk*cpk) * rt_auxvar%pri_act_coef(this%o2_id)
    ...
    ! NO2- -> NO
    cpk = Coc+K_S_OC_NO2
    drate_no2_no_oc = rate_no2_no / (Coc/cpk) * (cpk - 1.d0) / (cpk*cpk) * &
                      rt_auxvar%pri_act_coef(this%oc_id)
    cpk = Cno2+K_S_NO2
    drate_no2_no_no2 = rate_no2_no / (Cno2/cpk) * (cpk - 1.d0) / (cpk*cpk) * &
                       rt_auxvar%pri_act_coef(this%no2_id)
    drate_no2_no_biomass = rate_no2_no / X
    cpk = Cno3+K_I_NO3
    drate_no2_no_no3 = rate_no2_no / (K_I_NO3/cpk) * -1.d0 * K_I_NO3 / &
                       (cpk*cpk) * rt_auxvar%pri_act_coef(this%no3_id)
    ...
    ! NO -> N2O
    cpk = Coc+K_S_OC_NO
    drate_no_n2o_oc = rate_no_n2o / (Coc/cpk) * (cpk - 1.d0) / (cpk*cpk) * &
                      rt_auxvar%pri_act_coef(this%oc_id)
    cpk = Cno+K_S_NO
    drate_no_n2o_no = rate_no_n2o / (Cno/cpk) * (cpk - 1.d0) / (cpk*cpk) * &
                      rt_auxvar%pri_act_coef(this%no_id)
    ...
    ! N2O -> N2
    cpk = Coc+K_S_OC_N2O
    drate_n2o_n2_oc = rate_n2o_n2 / (Coc/cpk) * (cpk - 1.d0) / (cpk*cpk) * &
                      rt_auxvar%pri_act_coef(this%oc_id)
    cpk = Cno+K_S_NO
    drate_n2o_n2_n2o = rate_n2o_n2 / (Cn2o/cpk) * (cpk - 1.d0) / (cpk*cpk) * &
                       rt_auxvar%pri_act_coef(this%n2o_id)
    ...
    ! O2 ->
    cpk = Coc+K_S_OC_O2
    drate_o2_oc = rate_o2 / (Coc/cpk) * (cpk - 1.d0) / (cpk*cpk) * &
                  rt_auxvar%pri_act_coef(this%oc_id)
    cpk = Cno+K_S_O2
    drate_o2_o2 = rate_o2 / (Co2/cpk) * (cpk - 1.d0) / (cpk*cpk) * &

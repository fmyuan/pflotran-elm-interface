...
subroutine DenitrSetup(this,reaction,option)
  ...
  word = 'NO3-'
  this%ispec_no3 = GetPrimarySpeciesIDFromName(word,reaction, option)
  ...
  word = 'N2O(aq)'
  this%ispec_n2o = GetPrimarySpeciesIDFromName(word,reaction, option)
  ...
  word = 'N2(aq)'
  this%ispec_n2 = GetPrimarySpeciesIDFromName(word,reaction, option)
  ...
  word = 'NGASdeni'
  this%ispec_ngasdeni = GetImmobileSpeciesIDFromName(word,reaction%immobile, &
     PETSC_FALSE,option)

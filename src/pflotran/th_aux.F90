...
! auxvar%den_kg = 0.d0
  ...
  ! limiting temperature range 0 ~ 100, otherwise may have trouble in EOS
  !global_auxvar%temp    = min(100.d0, max(0.d0, global_auxvar%temp))
  ! 16.54 MPa is upper limit for using IFC67 EOS.

...
#include "petsc/finclude/petscsys.h"
  ...
  type, public, extends(option_type) :: option_flow_type
...
function OptionFlowCreate()
  ...
  type(option_flow_type), pointer :: OptionFlowCreate
  
  type(option_flow_type), pointer :: option

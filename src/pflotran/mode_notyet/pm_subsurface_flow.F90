...
subroutine PMSubsurfaceFlowReadSelectCase(this,input,keyword,found, &
  ...
  select case(trim(keyword))
    ...
    case('NUMERICAL_JACOBIAN')
      option_flow%numerical_derivatives = PETSC_TRUE
      if (option%resdef) then
    ...
    case('ANALYTICAL_JACOBIAN')
      option_flow%numerical_derivatives = PETSC_FALSE
    ...
    case('ANALYTICAL_JACOBIAN_COMPARE')
      option_flow%numerical_derivatives_compare = PETSC_TRUE
    ...
    case('NUMERICAL_AS_ALYT')
      option_flow%num_as_alyt_derivs = PETSC_TRUE
...
subroutine PMSubsurfaceFlowSetup(this)
  ...
  if (this%option_flow%transient_porosity) then
...
subroutine PMSubsurfaceFlowInitializeTimestepA(this)
  ...
  this%option_flow%dt = this%option%dt
...
subroutine PMSubsurfaceFlowUpdateSolution(this)
  ...
  if (this%option%store_fluxes) then

...
!....................
  ...
  call InputPopBlock(input,option) ! SUBSURFACE
    ...
    do local_id = 1, clm_pf_idata%nlclm_sub
      ...
      material_property%full_permeability_tensor = material_property_default%full_permeability_tensor
      ...
      material_property%electrical_conductivity = material_property_default%electrical_conductivity
      ...
      if (option%use_mc) then
        ...
        material_property%multicontinuum%length = material_property_default%multicontinuum%length
        material_property%multicontinuum%matrix_block_size = material_property_default%multicontinuum%matrix_block_size
        material_property%multicontinuum%fracture_spacing = material_property_default%multicontinuum%fracture_spacing
        material_property%multicontinuum%radius = material_property_default%multicontinuum%radius
        material_property%multicontinuum%area = material_property_default%multicontinuum%area
        material_property%multicontinuum%epsilon = material_property_default%multicontinuum%epsilon
        material_property%multicontinuum%aperture = material_property_default%multicontinuum%aperture
        material_property%multicontinuum%init_temp = material_property_default%multicontinuum%init_temp
        material_property%multicontinuum%init_conc = material_property_default%multicontinuum%init_conc
        material_property%multicontinuum%porosity = material_property_default%multicontinuum%porosity
        material_property%multicontinuum%diff_coeff = material_property_default%multicontinuum%diff_coeff
        material_property%multicontinuum%mnrl_volfrac = material_property_default%multicontinuum%mnrl_volfrac
        material_property%multicontinuum%mnrl_area = material_property_default%multicontinuum%mnrl_area
        material_property%multicontinuum%ncells = material_property_default%multicontinuum%ncells
        material_property%multicontinuum%log_spacing = material_property_default%multicontinuum%log_spacing
        material_property%multicontinuum%outer_spacing = material_property_default%multicontinuum%outer_spacing
        material_property%multicontinuum%area_scaling = material_property_default%multicontinuum%area_scaling
      endif
      ...
      write(string,*) material_property%external_id
      material_property%thermal_conductivity_function_name = "_TCC_"//trim(adjustl(string))

      material_property%creep_closure_id = 1 ! one is the index to a null pointer (NOT USED)
      material_property%creep_closure_name = '' ! (NOT USED)

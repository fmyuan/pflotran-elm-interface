module lambertw_module

! a package of functions to calculate Lambert W function
! in PFLOTRAN, it's used to inverse calculate 'plog_formulation',
! i.e. plog = c + ln(c),
!     then, c = W(exp(plog))

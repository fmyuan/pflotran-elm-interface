...
The ``1D Calcite Scenario'' simulates solute transport along a horizontal, 1D domain measuring 100 meters in length with unit cross sectional area.  Assumptions with regard to transport include:

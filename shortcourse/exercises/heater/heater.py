...
def make_subplots(nrow, ncol, nplots, filenames, columns, name, titles):
  for iplot in range(nplots):
    ...
    if iplot == 0: plt.ylabel('Temperature (C)', fontsize=14, fontweight='bold')
    elif iplot == 1: plt.ylabel('Saturation (-)', fontsize=14, fontweight='bold')
...
plt.savefig('heater.png',bbox_inches='tight')
plt.show()

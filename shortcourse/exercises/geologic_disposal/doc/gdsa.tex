...
\begin{semiverbatim}
  WASTE_FORM
     ...
     MECHANISM_NAME hlw \bluecomment{! dissolution mechanism & inventory}
  /
\end{semiverbatim}
\end{frame}
...
\begin{itemize}
  \item MECHANISM block for each type of waste
\end{itemize}
...
\begin{semiverbatim}\small
  MECHANISM GLASS
    ...
    SPECIES
    \bluecomment{!mass fractions are g/g glass}
    \bluecomment{!isotope, atom wt (g/mol), 1/s, g/g, instant release, daughter}

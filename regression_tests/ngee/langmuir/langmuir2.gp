...
plot 'langmuir2-obs-0.tec' using 1:($4*1000) title 'NH4+' with lines ls 1, \
     'langmuir2-obs-0.tec' using 1:($5/250*1000) title 'NH4+(s)' with lines ls 2, \
     'langmuir2-obs-0.tec' using 1:($4*1000+$5/250*1000) title 'total' with lines ls 3

set terminal postscript eps size 4, 3 enhanced color font 'Helvetica, 20' lw 1 
set output 'langmuir2.eps'
